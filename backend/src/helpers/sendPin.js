...
const sendPinForgotPass = (email, pin, name) => {
  ...
  return new Promise((resolve, reject) => {
    const msg = {
      ...
      to: email,
      subject: "Forgot Password appliance Rental",
      html: `
                <!DOCTYPE html>
                <html lang="en">
                ...
                <body>
                    ...
                    <main>
                        <p>
                            We have received a request to change your appliance RENTAL account password.
            ...
            <!DOCTYPE html>
                ...
                <body>
                    ...
                    <main>
                        <p>
                        Hi ${showName},
                        Thanks for register and welcome to the appliance Rental!
