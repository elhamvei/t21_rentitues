          ...
          <section className={`container ${styles["content-register"]}`}>
            <div className="row">
              ...
              <div className={`col-sm ${stylesLogin["line-center"]}`}>
                <span
                  className={`${stylesLogin["dotup"]} ${styles["dotup"]}`}
                ></span>
                <span
                  className={`${stylesLogin["dotdown"]} ${styles["dotdown"]}`}
                ></span>
              </div>
              <form
                className={`col-sm ${stylesLogin["input-form"]}`}
              ...
              >
                ...
                <Link
                  to="/forgot/password"
                  className={stylesLogin["forgot-pass"]}
                >
                  <p className={stylesLogin["forgot-pass"]}>Forgot Password?</p>
                </Link>
                <button type="submit" className={stylesLogin["btn-yellow"]}>
                  Sign Up
                </button>
