...
import { applianceSearchFilter } from "../../modules/utils/Appliance";
import {
  listHistoryUser,
  editHistory,
  delHistoryUser,
...
const History = () => {
  ...
  useEffect(() => {
    ...
    if (token) {
      ...
      applianceSearchFilter(urlNewArrival)
        .then((res) => {
          ...
          <React.Fragment>
            <article className={styles["flex-history"]}>
                  ...
                  {historyUser.length > 0 ? (
                    <React.Fragment>
                            ...
                            >
                              <div>
                                <img
                                  ...
                                  alt=""
                                  className={styles["img-history"]}
                                  style={{ position: "absolute", zIndex: 1 }}
                                />
                                <img
                                  src={applianceImgDefault}
                                  alt=""
                                  className={styles["img-history"]}
                                />
                              </div>
                              <div className={styles["box-text"]}>
                                <div className={styles["text-bold"]}>
                                  {data.name}
                                </div>
                                <div className={styles["text-history"]}>
                                  {data.renter_time}
                                </div>
                                <div
                                  className={styles["text-bold"]}
                                >{`Pre Payment : CAD ${formatCad(
                                  data.payment
                                )}`}</div>
                                <div
                                  className={styles["text-history"]}
                                  style={
                                    data.status === "Not been returned"
                                      ? { color: "red" }
                                      : { color: "green" }
                                  }
                                >
                      ...
                      <section
                        ...
                        style={{ marginTop: 23 }}
                      >
                        <p>{`Page ${meta.page} to remaining ${
                          meta.totalPage - meta.page
              ...
              <section className={styles["box-new-arrival"]}>
                <div>
                  <h5 style={{ textAlign: "center", marginBottom: 23 }}>
                    New Arrival
                  </h5>
                  {newArrival !== [] ? (
                    <React.Fragment>
                      ...
                      <p style={{ textAlign: "center", marginTop: 83 }}>
                        View More
                      </p>
                      <div
                      ...
                      >
                        <img
                          src={arrowIcon}
                          alt="avatar"
                          className={styles["arrow-view-more"]}
            ...
            {iseReturnEdit !== false ? (
              <React.Fragment>
                ...
                <Button
                  ...
                  onClick={AddEditRatingTestiHandler}
                >
                  Yes
                </Button>
              </React.Fragment>
