...
const carouselInner = (image, idx) => {
  ...
  if (showImg === "default")
    showImg = require("../../assets/img/appliance-default.png");
  return (
    <div
      className={`carousel-item ${styles["carousel-item-appliance"]} ${
        idx === 0 && "active"
      }`}
  ...
  return (
    ...
    >
      ...
      <div className={`row d-none d-sm-flex ${styles["preview-images"]}`}>
        ...
        <div
          className={`col-2 ${styles["right-arrow"]} ${styles["align-items-center"]}`}
        >
          <button
